...
<section class="hero-section12">
  <div class="container">
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Frame.png" class="main-illustration" alt="Student Vector">
    ...
    <div class="row mt-5" id="testimonialContainer">
      ...
      <div class="col-md-6 d-none testimonial-card-wrapper">
        <div class="testimonial-card mb-3">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tushar.png" class="testimonial-image" alt="Student">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Group 17.png" class="testimonial-company" alt="Company">
      ...
      <div class="col-md-6 d-none testimonial-card-wrapper">
        <div class="testimonial-card mb-3">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Group 19.png" class="testimonial-company" alt="Company">
      ...
      <!-- Add more cards similarly... -->
	   <div class="col-md-6 d-none testimonial-card-wrapper ">
        <div class="testimonial-card">
          <img src="https://via.placeholder.com/80" class="testimonial-image" alt="Student">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Frame.png" class="testimonial-company" alt="Company">
...
<section class="success-gallery-section">
  <div class="container">
    ...
    <p>
      We’re dedicating 1000+ hours of free training sessions across Maharashtra to fuel career opportunities and drive placements.
    </p>
  ...
  <div class="container mb-4">
   <!-- <h1 class="background-text1 m5b-0"></h1> -->
    ...
    <div class="position-relative">
      ...
      <!-- Controls -->
      <button class="btn btn-info text-white position-absolute top-50 start-0 translate-middle-y" onclick="slideLeft()">‹</button>
      <button class="btn btn-info text-white position-absolute top-50 end-0 translate-middle-y" onclick="slideRight()">›</button>
    </div>
  </div>
</section>
