  ...
  <div class="container">
    <div class="row gy-4">
      ...
      <div class="col-md-4">
        ...
        <p class="mb-0 mt-2 text-light"><i class="bi bi-envelope-fill me-2"></i>info@codefirstacademy.com</p>
      </div>
      ...
      <div class="col-md-8  mt-2">
       <hr>
        <div class="d-flex flex-wrap gap-4 text-white ">
          <p class="mb-1 mt-3"><i class="bi bi-telephone-fill me-2"></i>+91 99706 11896 / 98706 11896</p>
